...
impl Default for Tex1 {
    fn default() -> Self {
        ...
        //----- Materials
        let mut color = Material::copy(Material::unlit());
        color
            .id("color mat")
